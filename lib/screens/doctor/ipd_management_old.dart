...
class IpdManagementOld extends StatefulWidget {
  const IpdManagementOld({super.key});

  @override
  State<IpdManagementOld> createState() => _IpdManagementOldState();
}

class _IpdManagementOldState extends State<IpdManagementOld> {

  String _selectedFilter = 'All';
  String _selectedTab = 'Vital Monitoring';
